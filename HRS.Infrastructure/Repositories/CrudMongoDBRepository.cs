...
public class CrudMongoDBRepository<T> : ICrudMongoDBRepository<T> where T : class
{
    ...
    public async Task UpdateStatusByOrderIdAsync(object orderId, RentalStatus status) =>
